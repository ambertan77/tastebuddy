...
const ButtonTemplate = ({ type, size, text, onPress }: ButtonProps) => {
    const backgroundColour = type === "green" ? "bg-green-700" : type === "filter" ? "bg-green-700 rounded-xl" : type === "logout" ? "bg-amber-600" : type === "add" ? "bg-transparent" : "bg-transparent";
    ...
    const border = type === "add" ? "border border-gray-500" : type === "search" ? "border border-white" : "";
    return (
        <TouchableOpacity
            onPress={onPress}
